...
4. Run `pnpm dev` in this repo and verify login, `/app/workspace` list/create, `/app/workspace/:projectId/edit` save, and `/app/workspace/:projectId/preview` HTML preview.
