...
| dataflow-004   | `docs-site/architecture/data-flow.md`  | app/api/workspace-project.ts:11 (WORKSPACE_NEW_PROJECT_ID); app/api/workspace-project.ts:39 (getWorkspaceNewDocPath)                                                                                                                   |
...
| arch-001       | `docs/architecture.md`                 | app/api/workspace-project.ts:11 (WORKSPACE_NEW_PROJECT_ID)                                                                                                                                                                             |
| arch-004       | `docs/architecture.md`                 | app/api/workspace-project.ts:11 (getWorkspaceDocPath); app/api/workspace-project.ts:39 (getWorkspaceNewDocPath)                                                                                                                        |
