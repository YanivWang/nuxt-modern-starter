...
## doc-claims 证据（本批源码关联 20 条）

| claim          | 文档                                   | evidenceHint                                                                                                                                                                                                                           |
| -------------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| routing-001    | `docs-site/architecture/routing.md`    | config/routes.ts:12 (isProductPath); config/routes.ts:10 (productRoutePatterns)                                                                                                                                                        |
| routing-009    | `docs-site/architecture/routing.md`    | app/api/workspace-project.ts:12 (WORKSPACE_NEW_PROJECT_ID); app/features/editor/composables/useDraftProject.ts:58 (ensureDraftProject)                                                                                                 |
...
| dataflow-004   | `docs-site/architecture/data-flow.md`  | app/api/workspace-project.ts:12 (WORKSPACE_NEW_PROJECT_ID); app/api/workspace-project.ts:12 (getWorkspaceNewDocPath)                                                                                                                   |
| dataflow-005   | `docs-site/architecture/data-flow.md`  | app/api/workspace-project.ts:10 (fetchWorkspaceProjects); app/api/workspace-project.ts:10 (createWorkspaceProject); app/api/workspace-project.ts:11 (updateWorkspaceProject); app/api/workspace-project.ts:11 (deleteWorkspaceProject) |
| arch-001       | `docs/architecture.md`                 | app/api/workspace-project.ts:12 (WORKSPACE_NEW_PROJECT_ID)                                                                                                                                                                             |
| arch-004       | `docs/architecture.md`                 | app/api/workspace-project.ts:11 (getWorkspaceDocPath); app/api/workspace-project.ts:12 (getWorkspaceNewDocPath)                                                                                                                        |
| feature-001    | `docs-site/development/add-feature.md` | app/api/auth.ts:4 (createProductApiClient); app/api/workspace-project.ts:10 (fetchWorkspaceProjects)                                                                                                                                   |
| deploy-002     | `docs-site/deployment/overview.md`     | app/api/workspace-project.ts:12 (WORKSPACE_NEW_PROJECT_ID); app/features/editor/types.ts:13 (EDITOR_AUTOSAVE_DEBOUNCE_MS)                                                                                                              |
| overview-001   | `docs-site/architecture/overview.md`   | app/api/auth.ts:4 (createProductApiClient); app/api/auth.ts:12 (createAuthApiClient)                                                                                                                                                   |
...
| http-doc-001   | `docs-site/tech-stack/http.md`         | app/lib/http/client.ts:39 (assertApiEnvelope); app/lib/http/client.ts:25 (assertApiSuccess)                                                                                                                                            |
