...
| routing-008    | `docs-site/architecture/routing.md`      | config/site.ts:11 (DEFAULT_LOCALE); config/site.ts:12 (SITE_LOCALE_PREFIX_MAP); config/routes.ts:13 (localizedPath)   |
| dataflow-007   | `docs-site/architecture/data-flow.md`    | nuxt.config.ts:106 (apiBase)                                                                                          |
...
| deploy-001     | `docs-site/deployment/overview.md`       | nuxt.config.ts:106 (apiBase); nuxt.config.ts:107 (siteUrl)                                                            |
...
| config-004     | `docs-site/reference/config.md`          | nuxt.config.ts:106 (apiBase)                                                                                          |
| i18n-001       | `docs-site/architecture/i18n.md`         | config/routes.ts:13 (localizedPath); config/routes.ts:12 (isProductPath)                                              |
| i18n-002       | `docs-site/architecture/i18n.md`         | config/site.ts:11 (SUPPORTED_LOCALES); config/site.ts:11 (DEFAULT_LOCALE)                                             |
| directory-001  | `docs-site/architecture/directory.md`    | config/site.ts:4 (PUBLIC_PAGE_PATHS); config/routes.ts:12 (isProductPath)                                             |
| index-001      | `docs-site/index.md`                     | config/content/faq.ts:10 (faqItems); config/content/faq.ts:14 (getFaqItems)                                           |
| guide-gs-002   | `docs-site/guide/getting-started.md`     | nuxt.config.ts:106 (apiBase)                                                                                          |
...
| nuxt-001       | `docs-site/tech-stack/nuxt.md`           | nuxt.config.ts:24 (@nuxt/test-utils/module)                                                                           |
| nuxt-002       | `docs-site/tech-stack/nuxt.md`           | nuxt.config.ts:97 (additionalData)                                                                                    |
| styles-002     | `docs-site/tech-stack/styles.md`         | config/theme.ts:149 (applyThemeCssVariables)                                                                          |
| antd-doc-001   | `docs-site/tech-stack/ant-design-vue.md` | nuxt.config.ts:122 (extractStyle)                                                                                     |
